...
></v-switch>
  ...
  export default {
    ...
    methods: {
      initialize() {
        this.desserts = [
          { name: 'HELLO_ORACLE', city: 'Benagluru', lab: 'Lab_Test', isActive: 'YES', inUse: 'NO',supportedBenakMark:"H_ORACLE",OccupiedBy:"OccupiedBy" ,assign:true },
         
         
          { name: 'HELLO_ORACLE', city: 'Benagluru', lab: 'Lab_Test', isActive: 'YES', inUse: 'NO',supportedBenakMark:"H_ORACLE",OccupiedBy:"OccupiedBy" ,assign:false },
